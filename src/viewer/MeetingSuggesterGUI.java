...
public class MeetingSuggesterGUI {
	...
	private void initialize(UserDatabase udb) {
		...
		txtfIntervalStart = new JTextField("M/d/yyyy h:m AM/PM");
		...
		txtfIntervalFinish = new JTextField("M/d/yyyy h:m AM/PM");
	...
	private void findSlots(){
		SimpleDateFormat sdf = new SimpleDateFormat("M/d/yy h:mm aa", Locale.US);
		...
		try {
			...
			infoBox("Incorrect interval start, please use format: M/d/yyyy h:m AM/PM\n Ex: 3/13/2015 8:00 AM", "Interval Error");
			return;
		}
		try {
			finite = sdf.parse(txtfIntervalFinish.getText());
		} catch (ParseException e) {
			infoBox("Incorrect interval end, please use format: M/d/yyyy h:m AM/PM\n Ex: 3/13/2015 5:00 PM", "Interval Error");
			return;
		}
		try {
